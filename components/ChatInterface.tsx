              ...
              <div className="mt-2 ml-1 flex flex-col gap-1">
                ...
                {msg.relatedLinks.map((link, idx) => (
                  <a 
                    ...
                    className="flex items-center gap-2 text-xs bg-slate-800/50 hover:bg-slate-700 text-indigo-300 px-3 py-2 rounded-lg border border-slate-700/50 transition-colors"
                  >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <div className="flex gap-2 p-1 bg-slate-800 rounded-lg self-start">
            <button
              ...
              className={`px-3 py-1.5 text-xs font-semibold rounded-md transition-all ${mode === 'chat' ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:text-slate-200'}`}
            >
              Chat & Advice
            </button>
            <button
              ...
              className={`px-3 py-1.5 text-xs font-semibold rounded-md transition-all flex items-center gap-1 ${mode === 'edit' ? 'bg-emerald-600 text-white shadow-md' : 'text-slate-400 hover:text-slate-200'} ${!currentImageBase64 ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full bg-slate-800 text-white rounded-xl pl-4 pr-12 py-3 text-sm focus:ring-2 focus:ring-indigo-500 outline-none border border-transparent resize-none h-12"
